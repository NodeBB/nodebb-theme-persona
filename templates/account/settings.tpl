	...
	<div class="row">
		<div class="col-xs-12 col-md-6">
			...
			<div class="well">
				<div class="form-group">
					...
					<small class="form-text text-muted">[[user:homepage-description]]</small>
				</div>
				<div id="homePageCustom" class="form-group" style="display: none;">
					...
					<small class="form-text text-muted">[[user:custom-route-help]]</small>
				</div>
			</div>
			...
			<div class="well">
				...
				<div class="checkbox">
					<label>
						<input type="checkbox" data-property="showemail" <!-- IF settings.showemail -->checked <!-- ENDIF settings.showemail -->/> <strong>[[user:show-email]]</strong>
					</label>
				</div>
				<!-- ENDIF !hideEmail -->
				...
				<div class="checkbox">
					<label>
						<input type="checkbox" data-property="showfullname" <!-- IF settings.showfullname -->checked<!-- ENDIF settings.showfullname -->/> <strong>[[user:show-fullname]]</strong>
					</label>
				</div>
				<!-- ENDIF !hideFullname -->
				...
				<div class="checkbox">
					<label>
						<input type="checkbox" data-property="restrictChat" <!-- IF settings.restrictChat -->checked<!-- ENDIF settings.restrictChat -->/> <strong>[[user:restrict-chats]]</strong>
					</label>
				</div>
			...
			<div class="well">
				<div class="checkbox">
					<label>
						<input type="checkbox" data-property="openOutgoingLinksInNewTab" <!-- IF settings.openOutgoingLinksInNewTab -->checked<!-- ENDIF settings.openOutgoingLinksInNewTab -->/> <strong>[[user:open-links-in-new-tab]]</strong>
					</label>
				</div>
				<!-- IF inTopicSearchAvailable -->
				<div class="checkbox">
					<label>
						<input type="checkbox" data-property="topicSearchEnabled" <!-- IF settings.topicSearchEnabled -->checked<!-- ENDIF settings.topicSearchEnabled -->/> <strong>[[user:enable-topic-searching]]</strong>
					</label>
				</div>
				<small class="form-text text-muted">[[user:topic-search-help]]</small>
				<!-- ENDIF inTopicSearchAvailable -->
				<div class="checkbox">
					<label>
						<input type="checkbox" data-property="scrollToMyPost" <!-- IF settings.scrollToMyPost -->checked<!-- ENDIF settings.scrollToMyPost -->/> <strong>[[user:scroll-to-my-post]]</strong>
					</label>
				</div>
			</div>
			...
			<div class="well">
				<div class="checkbox">
					<label>
						<input type="checkbox" data-property="usePagination" <!-- IF settings.usePagination -->checked<!-- ENDIF settings.usePagination -->> <strong>[[user:paginate-description]]</strong>
					</label>
				</div>

				<strong>[[user:topics-per-page]] ([[user:max-items-per-page, {maxTopicsPerPage}]])</strong><br /> <input type="text" class="form-control" data-property="topicsPerPage" value="{settings.topicsPerPage}"><br />
				<strong>[[user:posts-per-page]] ([[user:max-items-per-page, {maxPostsPerPage}]])</strong><br /> <input type="text" class="form-control" data-property="postsPerPage" value="{settings.postsPerPage}"><br />
			</div>
			...
			<div class="well">
				<div class="form-group">
					...
					<small class="form-text text-muted">[[user:digest-description]]</small>
				</div>
			</div>
		...
		<div class="col-xs-12 col-md-6">
			...
			<div class="well">
				<div class="checkbox">
					<label>
						<input type="checkbox" data-property="followTopicsOnCreate" <!-- IF settings.followTopicsOnCreate -->checked <!-- ENDIF settings.followTopicsOnCreate -->/> <strong>[[user:follow-topics-you-create]]</strong>
					</label>
				</div>
				<div class="checkbox">
					<label>
						<input type="checkbox" data-property="followTopicsOnReply" <!-- IF settings.followTopicsOnReply -->checked<!-- ENDIF settings.followTopicsOnReply -->/> <strong>[[user:follow-topics-you-reply-to]]</strong>
					</label>
				</div>
				<div class="form-group">
