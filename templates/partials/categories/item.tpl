<li component="categories/category" data-cid="{../cid}" data-numRecentReplies="1" class="row clearfix">
	...
	<div class="col-lg-7 col-md-9 col-sm-12 content">
		<div class="icon pull-xs-left" style="{function.generateCategoryBackground}">
		...
		<span class="hidden-md-up pull-xs-right">
