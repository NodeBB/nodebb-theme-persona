<nav aria-label="Page navigation" component="pagination" class="text-xs-center pagination-container<!-- IF !pagination.pages.length --> hidden-xs-up<!-- ENDIF !pagination.pages.length -->">
	...
	<ul class="pagination hidden-md-up">
		...
		<li class="page-item last<!-- IF !pagination.next.active --> disabled<!-- ENDIF !pagination.next.active -->">
			<a class="page-link" href="?page={pagination.pageCount}" data-page="{pagination.pageCount}"><i class="fa fa-fast-forward"></i> </a>
		</li>
	</ul>
</nav>