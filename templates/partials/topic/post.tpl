<div class="clearfix post-header">
	...
	<small class="pull-left">
		<strong>
			<a href="<!-- IF posts.user.userslug -->{config.relative_path}/user/{posts.user.userslug}<!-- ELSE -->#<!-- ENDIF posts.user.userslug -->" itemprop="author" data-username="{function.showDisplayName, posts.user}" data-uid="{posts.user.uid}">{function.showDisplayName, posts.user}</a>
		</strong>
