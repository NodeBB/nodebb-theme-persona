...
<li class="dropdown-item" role="presentation" class="dropdown-header">[[topic:tools]]</li>
...
<li class="dropdown-item" role="presentation">
	<a component="post/delete" role="menuitem" tabindex="-1" href="#" class="<!-- IF posts.deleted -->hidden-xs-up<!-- ENDIF posts.deleted -->">
		<div class="inline menu-icon"><i class="fa fa-trash-o"></i></div> <span>[[topic:delete]]</span>
	</a>
</li>
<li class="dropdown-item" role="presentation">
	<a component="post/restore" role="menuitem" tabindex="-1" href="#" class="<!-- IF !posts.deleted -->hidden-xs-up<!-- ENDIF !posts.deleted -->">
		<div class="inline menu-icon"><i class="fa fa-history"></i></div> <span>[[topic:restore]]</span>
	</a>
</li>
<li class="dropdown-item" role="presentation">
	<a component="post/purge" role="menuitem" tabindex="-1" href="#" class="<!-- IF !posts.deleted -->hidden-xs-up<!-- ENDIF !posts.deleted -->">
...
<li class="dropdown-item" role="presentation">
	<a component="post/favourite" role="menuitem" tabindex="-1" href="#" data-favourited="{posts.favourited}">
		...
		<i component="post/favourite/on" class="fa fa-heart <!-- IF !posts.favourited -->hidden-xs-up<!-- ENDIF !posts.favourited -->"></i>
		<i component="post/favourite/off" class="fa fa-heart-o <!-- IF posts.favourited -->hidden-xs-up<!-- ENDIF posts.favourited -->"></i>
	</a>
</li>
...
<div class="dropdown-divider"></div>
<li class="dropdown-item" role="presentation" class="dropdown-header">[[topic:share_this_post]]</li>
