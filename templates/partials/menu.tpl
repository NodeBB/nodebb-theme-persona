			...
			<div id="nav-dropdown" class="hidden-xs">
				...
				<ul id="main-nav" class="nav navbar-nav">
					...
					<li class="{navigation.class}">
						<a href="{navigation.route}" title="{navigation.title}" <!-- IF navigation.id -->id="{navigation.id}"<!-- ENDIF navigation.id --><!-- IF navigation.properties.targetBlank --> target="_blank"<!-- ELSE --> target="_self"<!-- ENDIF navigation.properties.targetBlank -->>
